...
object Utils {
    ...
    fun flightToMap(f: Flight): Map<String, Any?> =
        mapOf(
    ...
    fun connectingFlightToMap(cf: ConnectingFlight): Map<String, Any?> =
        mapOf(
            ...
            "priceEconomy" to
                if (cf.leg1.priceEconomy != null && cf.leg2.priceEconomy != null) {
                    cf.leg1.priceEconomy + cf.leg2.priceEconomy
                } else {
                    null
                },
            "priceBusiness" to
                if (cf.leg1.priceBusiness != null && cf.leg2.priceBusiness != null) {
                    cf.leg1.priceBusiness + cf.leg2.priceBusiness
                } else {
                    null
                },
            "priceFirst" to
                if (cf.leg1.priceFirst != null && cf.leg2.priceFirst != null) {
                    cf.leg1.priceFirst + cf.leg2.priceFirst
                } else {
                    null
                },
